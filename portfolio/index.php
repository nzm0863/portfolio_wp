...
<head>
  ...
  <section class="works">
    ...
    <ul class="works-items">
      <li class="works-item" v-for="work in works" :key="work.id">
        ...
        />
        <h3 v-html="work.title.rendered"></h3>
  ...
  <section class="skill">
    ...
    <ul class="skill-items">
      <li class="skill-item" v-for="skill in skills" :key="skill.id">
        <img
          v-if="skill.featured_media_url"
          :src="skill.featured_media_url"
          :alt="skill.title?.rendered || ''"
          style="width: 100px; height: auto; margin-bottom: 10px"
        />
        <h3 v-html="skill.title?.rendered || ''"></h3>
  ...
  <section class="about">
    ...
    <div class="about-items">
      <img src="<?php echo get_template_directory_uri(); ?>/img/me.jpg" alt="me" id="aboutImage" />
